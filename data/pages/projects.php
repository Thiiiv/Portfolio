...
<html lang="fr">
    ...
    <body>
        ...
        <section class="page accueil" id="accueil">
            ...
            <a href="#summary" class="arrow">↓</a>
        </section>
        <section class="page page1" id="summary">
            <div class="summary">
        ...
        <section class="page page1 project" id="robot" >
        ...
        <section class="page page1 project" id="unesco" >
                <div class="projet-title-div">
                    <span class="projet-title">Site Web Unesco</span>
                </div>
                <div class="projet-media">
                    <a href="https://github.com/Thiiiv/SAE-Site-Web"><img src="../images/cordoue.png" alt="Website Unesco Image" id="media" /></a>
                </div>
                <div class="projet-text">
                    <span class="projet-span">
        ...
        <section class="page page1 project" id="python" >
                <div class="projet-title-div">
        ...
        <section class="page page1 project" id="java" >
                <div class="projet-title-div">
        ...
        <section class="page page1 project" id="ihm" >
                <div class="projet-title-div">
    ...
    <script src="../scriptJS/dock.js"></script>
</html>